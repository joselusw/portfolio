  ...
  jobs: [
    ...
    },
    {
      ...
      technologies: [
        ...
        "Angular",
        "LLM Integration (RAG, Semantic Kernel)",
        "Terraform / Infrastructure as Code",
        "OpenTelemetry",
      ],
      achievements: [
        "Developing and maintaining enterprise-scale applications using C#, ASP.NET and Angular",
        "Architecting cloud-native microservices on Azure",
        "Leading performance optimisation and CI/CD pipeline improvements",
      ],
      logoUrl:
